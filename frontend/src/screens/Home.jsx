    ...
    return (
        ...
        >
            ...
            <div className="flex flex-col flex-1 min-w-0 px-4 gap-4 overflow-y-auto overflow-x-hidden">
                ...
                {/* Conteúdo principal */}
                <div className=""
                    style={{ flex: 1, paddingLeft: '84px', paddingRight: '16px', minWidth: 0 }}>
                    <div style={{ flexShrink: 0 }} />


                    {/* Barra de mercados */}
                    <div className="flex items-center gap-6 text-[#D7D7D7] mb-5 pl-10" style={{ flexShrink: 0 }}>
                    ...
                    <div className="flex flex-col bg-[#49475B] w-full rounded-xl p-3.5 gap-18" style={{ flex: 1 }}>
                        ...
                        {/* Section top */}
                        <div className="flex gap-5 min-h-85 w-full flex-wrap lg:flex-nowrap">
                            ...
                            <div className="bg-[#31303A] text-[#FFFFFF] h-full flex flex-col justify-between font-medium rounded-xl shadow-[4px_9px_20px_rgba(0,0,0,0.30)] shrink-0 overflow-hidden min-w-70 sm:w-56">
                                <div className="flex flex-col gap-3">
                                    ...
                                    <div className="flex flex-col pl-2 pr-2 gap-2">
                                        <div className="flex gap-4 items-center">
                                            <div className="bg-[#D3CFFF] p-2 rounded-lg shrink-0 text-[#31303A] text-sm min-w-9 text-center"><p className="font-bold">1/2</p></div>
                                        ...
                                        <div className="flex gap-4 items-center">
                                            <div className="bg-[#D3CFFF] p-2 rounded-lg shrink-0 text-[#31303A] text-sm min-w-9 text-center"><p className="font-bold">3/4</p></div>
                                        ...
                                        <div className="flex gap-4 items-center">
                                            <div className="bg-[#D3CFFF] p-2 rounded-lg shrink-0 text-[#31303A] text-sm min-w-9 text-center"><p className="font-bold">0/3</p></div>
