    ...
    const infoPlans = [
        {
            ...
            link: "/", btn: "ASSINAR", popular: false, basic: true, premium: false,
        },
        {
            title: "Popular",
            infos: [
            ...
            link: "/", btn: "ASSINAR", popular: true, basic: false, premium: false,
        },
        {
            title: "Premium",
            infos: [
            ...
            link: "/", btn: "ASSINAR", popular: false, basic: false, premium: true,
        },
    ];
    ...
    return (
        ...
        >
            <div className="relative" onClick={e => e.stopPropagation()}>
                ...
                <button
                    onClick={onClose}
                    className="absolute -top-8 right-2 text-[#96DAE3]/70 hover:text-[#96DAE3] transition text-lg cursor-pointer font-bold"
                >
                    ✕
                </button>

                <section className='flex justify-center w-full text-white'>
                        ...
                        {infoPlans.map((plan) => (
                            ...
                            >
                                <div className={`flex flex-col justify-between p-6 bg-linear-to-t from-[#1D1C2A] via-[#1d1c2ab6] to-transparent
                                    ${plan.popular ? 'min-h-120 w-120 rounded-b-2xl border border-[#96DAE3]/40' : 'min-h-95 w-95'}
                                    ${plan.premium ? 'rounded-r-2xl' : ''} ${plan.basic ? 'rounded-l-2xl' : ''}`}
                                >
                                    ...
                                    <div className='flex flex-col items-center gap-2 mt-auto'>
                                        <a href={plan.link}
                                            className={`w-full text-center text-xl bg-[#96DAE3] text-[#2a2935] shadow-[0px_3px_6px_#1819198a] font-bold py-1 rounded-sm duration-300 transition-all 
...
export default function Home() {
    ...
    const [planosModalOpen, setPlanosModalOpen] = useState(false); // ← NOVO
    ...
    return (
        ...
        >
            ...
            <div className="flex flex-col flex-1 min-w-0 px-4 gap-4 overflow-y-auto overflow-x-hidden">
                        ...
                        <div className="flex gap-5 w-full flex-wrap lg:flex-nowrap">
                            <div className="bg-[#31303A] text-[#E5E3FF] font-bold flex flex-col gap-6 rounded-lg shadow-[4px_9px_20px_rgba(0,0,0,0.30)] pt-3 px-2 pb-3 pl-5 max-w-82 flex-1">
                                ...
                                <div className="flex flex-col gap-3">
                                    <div className="flex gap-4 items-center"><div className="bg-[#E5E3FF] p-2 rounded-lg shrink-0"><img src="../../public/Vendas.svg" alt="Vendas" className="w-7" /></div><span className="text-sm">Vendas: R$2.912,24 <span className="text-[#5FB057]">(+)</span></span></div>
                                    <div className="flex gap-4 items-center"><div className="bg-[#E5E3FF] p-2 rounded-lg shrink-0"><img src="../../public/Produtos.svg" alt="Produtos" className="w-7" /></div><span className="text-sm">Produtos: R$1.734,86 <span className="text-[#B93F3F]">(-)</span></span></div>
                                    <div className="flex gap-4 items-center"><div className="bg-[#E5E3FF] p-2 rounded-lg shrink-0"><img src="../../public/Frete.svg" alt="Frete" className="w-7" /></div><span className="text-sm">Frete: R$226,40 <span className="text-[#B93F3F]">(-)</span></span></div>
                                    <div className="flex gap-4 items-center"><div className="bg-[#E5E3FF] p-2 rounded-lg shrink-0"><img src="../../public/Total.svg" alt="Total" className="w-7" /></div><span className="text-sm">Total: <span className="text-[#5FB057]">R$950,98</span></span></div>
                                </div>
                            </div>
                            ...
                            <div className="bg-[#31303A] text-[#E5E3FF] font-bold flex flex-col gap-6 rounded-lg shadow-[4px_9px_20px_rgba(0,0,0,0.30)] pt-3 px-2 pb-3 pl-5 max-w-82 flex-1">
                                ...
                                <div className="flex flex-col gap-3">
                                    <div className="flex gap-4 items-center"><div className="bg-[#E5E3FF] p-2 rounded-lg shrink-0"><img src="../../public/Lucros.svg" alt="Lucros" className="w-7" /></div><span className="text-sm">Lucros: R$950,98 <span className="text-[#5FB057]">(+)</span></span></div>
                                    <div className="flex gap-4 items-center"><div className="bg-[#E5E3FF] p-2 rounded-lg shrink-0"><img src="../../public/Taxas.svg" alt="Taxas" className="w-7" /></div><span className="text-sm">Taxas: R$226,40 <span className="text-[#B93F3F]">(-1%)</span></span></div>
                                    <div className="flex gap-4 items-center"><div className="bg-[#E5E3FF] p-2 rounded-lg shrink-0"><img src="../../public/Total.svg" alt="Total" className="w-7" /></div><span className="text-sm">Total: <span className="text-[#5FB057]">R$941,47</span></span></div>
                                </div>
                            </div>
                            ...
                            <div className="bg-[#31303A] text-[#31303A] font-bold flex flex-col rounded-lg shadow-[4px_9px_20px_rgba(0,0,0,0.30)] pt-2 pb-3 px-2 min-w-64 flex-2">
                                <div className="flex justify-between items-start flex-wrap gap-2">
                                    ...
                                    <div className="flex gap-0.5">
                                        <span className="bg-[#E5E3FF] cursor-pointer rounded-l-[3px] px-1.5 py-0.5 text-sm">1 Dia</span>
                                        <span className="bg-[#E5E3FF] cursor-pointer px-1.5 py-0.5 text-sm">5 Dias</span>
                                        <span className="bg-[#E5E3FF] cursor-pointer px-1.5 py-0.5 text-sm">2 Semanas</span>
                                        <span className="bg-[#5E5991] cursor-pointer rounded-r-[3px] text-[#E5E3FF] px-1.5 py-0.5 text-sm">1 Mês</span>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div className="flex flex-wrap gap-5 h-full w-full items-start">
                                ...
                                {!googleConnected ? (
                                    ...
                                    <div className="bg-[#31303A] rounded-xl p-2 flex flex-col gap-2" style={{ minHeight: "417px" }}>
                                        <div className="flex gap-1" style={{ maxHeight: adsList.length >= 5 ? "325px" : "none" }}>
                                            <div ref={scrollRef} onScroll={handleScroll} className="flex flex-col gap-2 flex-1 hide-scrollbar" style={{ overflowY: adsList.length >= 3 ? "auto" : "visible" }}>
                                                {adsList.map((ad) => (
                                                    <div key={ad.id} className="bg-[#E5E3FF] rounded-xl flex items-center gap-3 px-3 py-2 shadow-md shrink-0">
                                                        ...
                                                        <div className="flex flex-col flex-1 min-w-0">
                                                            ...
                                                            <div className="flex items-center gap-3 mt-1 text-xs">
                                                                <span className="flex text-[#708BE7] items-center gap-1"><svg className="w-3.5 h-3.5" fill="none" viewBox="0 0 24 24" stroke="#708BE7"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M15 12a3 3 0 11-6 0 3 3 0 016 0z" /><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M2.458 12C3.732 7.943 7.523 5 12 5c4.477 0 8.268 2.943 9.542 7-1.274 4.057-5.065 7-9.542 7-4.477 0-8.268-2.943-9.542-7z" /></svg>{ad.visualizacoes.toLocaleString('pt-BR')}</span>
                                                                <span className="flex text-[#5CAEB8] items-center gap-1"><svg className="w-3.5 h-3.5" fill="none" viewBox="0 0 24 24" stroke="#5CAEB9"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M15 15l-2 5L9 9l11 4-5 2zm0 0l5 5" /></svg>{ad.cliques}</span>
                                                                <span className="flex text-[#5FB057] items-center gap-1"><svg className="w-3.5 h-3.5" fill="none" viewBox="0 0 24 24" stroke="#5FB057"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M3 3h2l.4 2M7 13h10l4-8H5.4M7 13L5.4 5M7 13l-2.293 2.293c-.63.63-.184 1.707.707 1.707H17m0 0a2 2 0 100 4 2 2 0 000-4zm-8 2a2 2 0 11-4 0 2 2 0 014 0z" /></svg>{ad.compras}</span>
                                                            </div>
                                                        </div>
                                                        <button className="text-[#31303A] hover:opacity-70 bg-[#D3CFFF] transition-opacity cursor-pointer shrink-0 flex flex-col gap-0.5 items-center p-3 px-2 rounded-md"
                                                            onClick={(e) => { e.stopPropagation(); const rect = e.currentTarget.getBoundingClientRect(); setMenuPos({ top: rect.bottom + 4, left: rect.right - 130 }); setAdMenuOpen(adMenuOpen === ad.id ? null : ad.id); }}>
                            ...
                            <div className="bg-[#31303A] text-[#FFFFFF] h-full flex flex-col justify-between font-medium rounded-xl shadow-[4px_9px_20px_rgba(0,0,0,0.30)] shrink-0 overflow-hidden min-w-70 sm:w-56">
                                <div className="flex flex-col gap-2">
                                    <div className="bg-[#E5E3FF] text-[#31303A] text-center p-2 font-bold"><span>Plano mensal: 80$</span></div>
                                    <div className="flex flex-col pl-2 pr-2 gap-2">
                                        <div className="flex gap-4 items-center">
                                            <div className="bg-[#E5E3FF] p-2 rounded-lg shrink-0 text-[#31303A] text-sm min-w-9 text-center font-bold"><p>1/2</p></div>
                                        ...
                                        <div className="flex gap-4 items-center">
                                            <div className="bg-[#E5E3FF] p-2 rounded-lg shrink-0 text-[#31303A] text-sm min-w-9 text-center font-bold"><p>3/4</p></div>
                                        ...
                                        <div className="flex gap-4 items-center">
                                            <div className="bg-[#E5E3FF] p-2 rounded-lg shrink-0 text-[#31303A] text-sm min-w-9 text-center font-bold"><p>0/3</p></div>
                                ...
                                {/* ← BOTÃO MELHORAR PLANO com onClick */}
                                <button
                                    onClick={() => setPlanosModalOpen(true)}
                                    className="bg-[#5E5991] p-4 font-medium cursor-pointer outline-none w-full hover:bg-[#5e5991b9] transition-all duration-300"
                                >
                                    Melhorar Plano
                                </button>
                            </div>
                            ...
                            <div className="flex items-end shrink-0 ml-auto mt-55">
                                <div className="bg-[#9997B1] flex flex-col rounded-xl shadow-[4px_9px_20px_rgba(0,0,0,0.30)] overflow-hidden w-44 h-48">
                                    <div className="flex-1 flex items-center justify-center"><p className="text-[#31303A] font-bold">Foto da sua loja</p></div>
                                    <button className="bg-[#5E5991] text-[#FFFFFF] font-medium p-3 cursor-pointer hover:bg-[#5e5991b9] transition-all duration-300 outline-none w-full">Acessar loja</button>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                {/* ← MODAL PLANOS */}
                {planosModalOpen && <PlanosModal onClose={() => setPlanosModalOpen(false)} />}
            </div>
        </div>
    );
}