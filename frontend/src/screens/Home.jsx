...
export default function Home() {
    ...
    function handlePostarAd() {
        ...
        if (typeof adModalOpen === 'number') {
            // Modo edição — atualiza o ad existente
    ...
    const [adMenuOpen, setAdMenuOpen] = useState(null); // guarda o id do ad com menu aberto

    return (
        /* FIX: h-screen + overflow-hidden no root → elimina scrollbars X e Y indesejados */
        <div className="bg-[#31303A] h-screen w-screen overflow-hidden flex" onClick={() => setAdMenuOpen(null)}>
            ...
            {/* FIX: scroll apenas aqui dentro, não na página inteira */}
            <div className="flex flex-col flex-1 min-w-0 px-4 pb-4 gap-4 overflow-y-auto overflow-x-hidden">
                ...
                {/* Barra de mercados */}
                <div className="flex items-center gap-8 ml-5 flex-wrap text-[#D7D7D7] shrink-0">
                ...
                <div className="flex flex-col bg-[#49475B] w-full rounded-xl p-3.5 gap-6">
                    ...
                    <div className="flex gap-5 w-full flex-wrap">
                        ...
                        {/* Card Gráfico */}
                        <div className="bg-[#31303A] text-[#31303A] flex flex-col font-medium rounded-lg shadow-[4px_9px_20px_rgba(0,0,0,0.30)] pt-2 pb-3 px-2 min-w-64 flex-[2]">
                    ...
                    <div className="flex flex-wrap gap-5 w-full">
                        ...
                        {/* GoogleAds — FIX: largura fixa de 280px para não ser pequeno demais */}
                        <div className="flex flex-col gap-2 min-w-80 shrink-0" style={{ width: "280px" }}>
                            {!googleConnected ? (
                                <div className="bg-[url('../../public/GoogleAds.svg')] bg-no-repeat bg-cover flex flex-col-reverse rounded-xl overflow-hidden" style={{ minHeight: "318px" }}>
                                    <button
                                    ...
                                    {adsList.length > 0 && (
                                        <div className="flex gap-1">
                                            <div
                                                ...
                                                className="flex flex-col gap-2 hide-scrollbar overflow-y-auto"
                                                style={{
                                                    flex: 1,
                                                    maxHeight: "240px"
                                                }}
                                                                ...
                                                                >
                                                                    ...
                                                                    <button
                                                                        onClick={() => {
                                                                            ...
                                                                            setAdModalOpen(ad.id); // passa o id para saber que é edição
                                                                            setAdMenuOpen(null);
                                                                        }}
                        ...
                        {/* Plano */}
                        <div className="bg-[#31303A] text-[#FFFFFF] flex flex-col justify-between font-medium rounded-xl shadow-[4px_9px_20px_rgba(0,0,0,0.30)] shrink-0 overflow-hidden" style={{ width: "220px" }}>
                        ...
                        <div className="flex items-end shrink-0 ml-auto">
                            <div className="bg-[#9997B1] flex flex-col rounded-xl shadow-[4px_9px_20px_rgba(0,0,0,0.30)] overflow-hidden" style={{ height: "192px", width: "176px" }}>
