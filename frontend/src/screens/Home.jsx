        ...
        <div className="bg-[#31303A] min-h-screen max-w-screen flex"> {/* Tela */}
            ...
            <div className="flex flex-col pl-5"> 
                <div className="flex justify-end pr-10 rounded-b-lg max-h-5"> {/* Setinha para baixo */}
                    <button className="bg-[#96DAE3] flex justify-center cursor-pointer rounded-b-[12px] p-1.5 max-w-12 outline-none"> <img src="../../public/Setinha.svg" alt="Seta apontando para baixo" className="w-[40%]"/> </button>
                </div>
                ...
                <div className="flex flex-col gap-4">
                    <div className="flex items-center text-center pl-10 gap-12 text-[#D7D7D7]"> {/* Mercados */}
                        ...
                        <button className="flex justify-center items-center font-medium border-2 rounded-[8px] w-8 h-8 cursor-pointer outline-none"> <span className="text-4xl">+</span> </button>
                    </div>

                    <div className="flex flex-col bg-[#49475B] rounded-[12px] h-[91vh] w-[94vw]"> {/* Conteúdo principal */}
                        <div className="flex gap-5 ml-5 mt-7"> {/* Section top */}
                            <div className="bg-[#31303A] text-[#E5E3FF] flex justify-center h-[35vh] w-[17vw] rounded-[8px] pt-8">
                                <p>Bruto</p>
                            </div>
                            ...
                            <div className="bg-[#31303A] text-[#E5E3FF] flex h-[35vh] w-[55.5vw] rounded-[8px] pt-2 pl-5 gap-3">
                        ...
                        <div className="flex gap-219 ml-5 mt-15"> {/* Section bottom */}
                            <div className="flex gap-5"> {/* Section bottom left */}
                                <div className="bg-[url('../../public/GoogleAds.svg')] bg-no-repeat bg-cover flex flex-col-reverse h-[43vh] w-[20vw] rounded-[8px]">
                                ...
                                <div className="bg-[#31303A] text-[#E5E3FF] flex justify-end text-center flex-col gap-30 h-[43vh] w-[15vw] rounded-[3px] rounded-b-lg">
                            ...
                            <div className="flex flex-col-reverse">
                                <div className="bg-[#9997B1] flex flex-col h-[20vh] w-[10vw] gap-24 pt-5 rounded-[8px] rounded-b-lg text-center"> {/* Section bottom right */}
